...
using System.Diagnostics.CodeAnalysis;       // for Image
...
namespace Id3Lib
{
    ...
    public class FramePicture : FrameBase, IFrameDescription
	{
        ...
        public Image Picture
        {
            get
            {
                Stream stream = new MemoryStream(_pictureData, false);
                return Image.FromStream(stream);
            }
            set
            {
                // TODO: obtain the format of the image from value.RawFormat
                // and use that (if suitable) instead of always jpeg
                MemoryStream memoryStream = new MemoryStream();
                value.Save(memoryStream, System.Drawing.Imaging.ImageFormat.Jpeg);
