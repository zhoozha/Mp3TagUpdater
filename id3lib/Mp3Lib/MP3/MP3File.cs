...
namespace Mp3Lib
{
	...
	public class Mp3File
    {
        ...
        public string FileName
        {
            get
            {
                return _sourceFileInfo.FullName;
            }
        }
        ...
        #region private initialise method
        ...
        private void RewriteFile(FileInfo bakFileInfo)
        {
            ...
            string tempName = Path.ChangeExtension(_sourceFileInfo.Name, "$$$");
            ...
            // re-initialise the mp3 file wrapper
            // this is a bit expensive, as having just updated the file on disk, 
            // the user will probably just throw away the mp3file anyway.
            // however, it's logically necessary given the mp3file model
            // (i.e. that the mp3file is an image of the current mp3 file on disk).
            // TODO: lazy-initialise the mp3file so it only gets done if needed again.
            Initialise();
        }
